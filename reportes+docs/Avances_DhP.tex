...
\begin{center}
\includegraphics[width=0.7\linewidth,height=\textheight,keepaspectratio]{../data/AnalisisGeografico/Analisis_Geografico_estaciones+ubi.png}
\end{center}
...
\begin{center}
\includegraphics[width=0.7\linewidth,height=\textheight,keepaspectratio]{../outputs/00.CLIMAS.png}
\end{center}
\begin{center}
...
{\centering \includegraphics[width=0.7\linewidth,height=\textheight,keepaspectratio]{../outputs/00.EDAFO.png}
...
{\centering \includegraphics[width=0.7\linewidth,height=\textheight,keepaspectratio]{../outputs/00.HIDRO.png}
