...
[^1]: El script con el que hicieron los mapas se encuentran en la sección de la sección de anexos [Script: mapas de caracterización climática]

## Tipos de clima 
![Mapa de tipos de clima en la zona de estudio](../outputs/00.CLIMAS.png){fig-align="center"}
![Mapa de tipos de clima por rango de humedad en la zona de estudio](../outputs/00.CLIM_HUM.png){fig-align="center"} 

## Edafología
![Edafología de la zona de estudio](../outputs/00.EDAFO.png){fig-align="center"} 
